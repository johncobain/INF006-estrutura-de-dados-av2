...
int main(){
    FILE *fp_test1 = fopen("L1Q1.out", "r");
    FILE *fp_res1 = fopen("./X2/L1Q1.out", "r");
    
    
    FILE *fp_test2 = fopen("L1Q2.out", "r");
    FILE *fp_res2 = fopen("./X2/L1Q2.out", "r");
    
    FILE *fp_test3 = fopen("L1Q3.out", "r");
    FILE *fp_res3 = fopen("./X2/L1Q3.out", "r");
